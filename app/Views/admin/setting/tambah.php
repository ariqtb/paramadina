<form action="<?= base_url('admin/tilawah/tambah') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	<?= csrf_field();
	?>
	...
	<div class="form-group row">
		...
		<div class="col-md-10">
			<input type="text" name="nama_tilawah" class="form-control" placeholder="Nama Peserta" value="<?= set_value('nama_tilawah') ?>" required>
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-3">
			<input type="text" name="tilawah_tempat_lahir" class="form-control" placeholder="Tempat lahir" value="<?= set_value('tilawah_tempat_lahir') ?>">
		</div>
		<div class="col-3">
	...
	<div class="form-group row">
		...
		<div class="col-md-10">
			<textarea name="tilawah_alamat" class="form-control"><?= set_value('tilawah_alamat') ?></textarea>
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-md-10">
			<input type="text" name="tilawah_telepon" class="form-control" placeholder="Telepon" value="<?= set_value('tilawah_telepon') ?>" required>
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-md-10">
			<input type="text" name="tilawah_email" class="form-control" placeholder="Email" value="<?= set_value('tilawah_email') ?>" required>
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-md-10">
        	<select name="cabang_lomba" class="form-control" required>
           		...
           		<option value="Tausiah">Tausiah</option>
	...
	<div class="form-group row">
		...
		<div class="col-md-10">
			<input type="file" name="tilawah_foto" class="form-control" value="<?= set_value('tilawah_foto') ?>">
		</div>
	</div>
	...
	<select hidden name="status_tilawah" class="form-control">
